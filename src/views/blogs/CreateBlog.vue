    ...
    <section class="container">
        <div class="content">
              <div class="field">
                ...
                <input class="input" type="text" name="title" placeholder="Blog title" v-model="title" value="">
              ...
              <div class="file">
                <label class="file-label">
                  <input class="file-input" type="file" ref="file" name="myImage" @change="handleFileUpload()">
                  <span class="file-cta">
              ...
              <div class="field is-grouped mt-3">
                <div class="control">
                  <input type="submit" class="button is-link" value="submit" @click="submit()">
                </div>
                <div class="control">
                  <button class="button is-link is-light" onclick="window.location.replace='/'">Back to home</button>
                </div>
              </div>
        </div>
    </section>
