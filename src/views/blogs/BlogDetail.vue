                    ...
                    <div class="card-image pt-5">
                        <div class="columns">
                            ...
                            <div v-for="image in images" :key="image.id" class="column">
                                <figure class="image">
                                    <img :src="image.file_path ? `http://localhost:3000/` + image.file_path : 'https://bulma.io/images/placeholders/480x480.png'"
                                ...
                                <article class="media">
                                    <div class="media-left">
                                        <figure class="image is-64x64">
                                            <img :src="comment.file_path ? `http://localhost:3000/` + comment.file_path : 'https://bulma.io/images/placeholders/128x128.png'"
                                                alt="Image">
                                        </figure>
                                    </div>
